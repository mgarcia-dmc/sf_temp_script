...
JOB_NAME = "nt_fin_gastos_trans_gold"
...
try:
    ...
    (col("RVERS") == "000") & 
    (col("KOKRS") == "GSFE") & 
    (col("RACCT").between("0060000000", "0069999999") | col("RACCT").isin("0090000000", "0095000000", "0095000001", "0090000005")) &
    (col("ACTIV").between("0000", "ZZZZ")))

    # Seleccionar columnas necesarias
    columns_to_selectGLPCA = ["RRCTY","RVERS","RYEAR","POPER","DOCCT","RBUKRS","RPRCTR","KOKRS","RACCT","HRKFT","RASSC","SPRCTR","SHOART","HSL","MSL","CPUDT","USNAM","DOCTY","BLDAT","BUDAT","REFRYEAR","REFDOCCT","WERKS","KOSTL","LSTAR","AUFNR","MATNR","KUNNR","EBELN","KSTRG","PS_PSP_PNR","KDAUF","FKART","CO_PRZNR","RSCOPE","BLART","SGTXT","LIFNR"]
