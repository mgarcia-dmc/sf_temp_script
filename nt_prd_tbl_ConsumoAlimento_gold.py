...
print('carga consumoalimento',df_ConsumoAlimento.count())
...
print('carga consumoalimentoupd',df_ConsumoAlimento_upd.count())
...
print('carga consumoalimento0',df_ConsumoAlimento0.count())
...
df_estadoTemp = spark.sql(f"select complexentityno,pk_estado,pk_empresa from {database_name}.stg_ProduccionDetalle \
...
df_ft_consumoalimento.write \
    ...
    .options(**additional_options) \
    .mode("overwrite") \
    .saveAsTable(f"{database_name}.ft_consumoalimento_Temp")
...
if datos_existentes:
    ...
    print(f"Tabla ft_onsumoalimentoTemporal eliminada correctamente de la base de datos '{database_name}'.")
