...
bucket_name_target = f"ue1stg{amb}as3dtl005-bronze"
bucket_name_source = f"ue1stg{amb}as3dtl001-landing"
bucket_name_prdmtech = f"UE1STG{amb.upper()}AS3PRD001/MTECH/SAN_FERNANDO/MAESTROS/"
...
bucket_name_target = f"ue1stg{amb}as3dtl005-bronze"
bucket_name_source = f"ue1stg{amb}as3dtl001-landing"
bucket_name_prdmtech = f"UE1STG{amb.upper()}AS3PRD001/SAP/MAESTROS/"
