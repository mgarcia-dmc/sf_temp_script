...
JOB_NAME = "nt_fin_zcot_trans_bronze"
...
processed_prefix = f"UE1STG{p_ambU}AS3FIN001/SAP/ZCOT_PROCESADOS/"
...
for row in lista_df.collect():
    ...
    prefix_source = f"UE1STG{p_ambU}AS3FIN001/SAP/ZCOT/"
    path_source = f"s3://{landing_bucket_name}/UE1STG{p_ambU}AS3FIN001/SAP/ZCOT/{table_name_source}_*.parquet"
    prefix_target = f"UE1STG{p_ambU}AS3FIN001/SAP/ZCOT/{table_name_target}/"
    prefix_target_temp = f"UE1STG{p_ambU}AS3FIN001/SAP/ZCOT/{table_name_target}_temp/"
