...
JOB_NAME = "nt_fin_huevo_trans_bronze"
...
path_lista = f"s3://ue1stg{p_amb}as3dtl001-landing/UE1STG{p_ambU}AS3FIN001/SAP/HUEVO/listatablas_huevo.txt"
...
processed_prefix = f"UE1STG{p_ambU}AS3FIN001/HUEVO/HUEVO_PROCESADOS/"
...
for row in lista_df.collect():
    ...
    prefix_source = f"UE1STG{p_ambU}AS3FIN001/SAP/HUEVO/"
    path_source = f"s3://{landing_bucket_name}/UE1STG{p_ambU}AS3FIN001/SAP/HUEVO/{table_name_source}_*.parquet"
    prefix_target = f"UE1STG{p_ambU}AS3FIN001/SAP/HUEVO/{table_name_target}/"
    prefix_target_temp = f"UE1STG{p_ambU}AS3FIN001/SAP/HUEVO/{table_name_target}_temp/"
