...
JOB_NAME = "nt_fin_copa_trans_silver"
...
for row in lista_df.collect():
    ...
    path_target = f"s3://ue1stg{p_amb}as3dtl005-silver/UE1STG{p_ambU}AS3FIN001/SAP/COPA/{table_name_target}"
    path_source = f"s3://ue1stg{p_amb}as3dtl005-bronze/UE1STG{p_ambU}AS3FIN001/SAP/COPA/{table_name_source}"
