...
JOB_NAME = "nt_fin_copa_trans_bronze"
...
path_lista = f"s3://ue1stg{p_amb}as3dtl001-landing/UE1STG{p_ambU}AS3FIN001/SAP/COPA/listatablas_copa.txt"
...
processed_prefix = f"UE1STG{p_ambU}AS3FIN001/SAP/COPA_PROCESADOS/"
...
for row in lista_df.collect():
    ...
    prefix_source = f"UE1STG{p_ambU}AS3FIN001/SAP/COPA/"
    path_source = f"s3://{landing_bucket_name}/UE1STG{p_ambU}AS3FIN001/SAP/COPA/{table_name_source}_*.parquet"
    prefix_target = f"UE1STG{p_ambU}AS3FIN001/SAP/COPA/{table_name_target}/"
    prefix_target_temp = f"UE1STG{p_ambU}AS3FIN001/SAP/COPA/{table_name_target}_temp/"
    ...
    if df_target is not None:
        ...
        df_target_after_deletions = df_target_after_deletions.drop("OPFLAG")  # No es necesario mantener OPFLAG para la historia
    ...
    print("Registros initial:", df_target.count())
