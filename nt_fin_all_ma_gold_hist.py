...
JOB_NAME = "nt_fin_all_ma_gold_hist"
...
for row in lista_df.collect():
    ...
    path_source = f"s3://{silver_bucket_name}/UE1STG{p_ambU}AS3FIN001/SAP/MAESTROS/{table_name_source}"
    path_target = f"s3://{gold_bucket_name}/UE1STG{p_ambU}AS3FIN001/SAP/MAESTROS/{table_name_target}"
